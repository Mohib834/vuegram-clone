  ...
  <main style="background:#fff">
    <section>
      <v-container fluid="" class="pa-0" style="position:relative;height: 80vh">
        ...
        >
          <span class="d-block white--text text-center mt-n3 caption">
            {{ blog.blogContent.createdAt }}
          </span>
          <h1 class="display-4 white--text text-center">
            {{ blog.blogContent.blogTitle }}
          </h1>
              ...
              <v-sheet width="680px" color="transparent" class="mx-auto">
                ...
                <v-list color="transparent">
                  ...
                  >
                    ...
                    <v-avatar
                      class="mr-2"
                      style="position:relative; left: -6px;top:-16px"
                    >
                      <v-icon color="primary" dark size="60px"
                        >mdi-account-circle</v-icon
                      >
                    </v-avatar>
                    <v-sheet class="d-flex flex-column" width="100%" color="transparent" min-height="70px">
                      <v-list-item-title class="mb-1 mr-auto font-weight-bold">
                        {{ comment.by }}
                      </v-list-item-title>
                      ...
                      <v-btn color="#F32013" height="30px" class="mb-3 font-weight-bold mt-3 ml-auto" dark style="border-radius:0; font-size: 10px;">
                        delete
                      </v-btn>
                      <v-divider />
                    </v-sheet>
